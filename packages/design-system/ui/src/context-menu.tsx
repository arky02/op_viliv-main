...
>(({ className, ...props }, ref) => (
	<ContextMenuPrimitive.Portal>
		<ContextMenuPrimitive.Content
			className={cn(
				'bg-background text-foreground animate-in fade-in-80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 border-strong z-50 min-w-[8rem] overflow-hidden rounded-md border p-2 shadow-lg',
				className
			)}
			ref={ref}
			{...props}
...
>(({ className, inset, ...props }, ref) => (
	<ContextMenuPrimitive.Label
		className={cn(
			'text-secondary-foreground p-2 text-sm font-medium',
			inset && 'pl-8',
			className
		)}
		ref={ref}
